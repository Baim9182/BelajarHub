...
local script_id, game_name = _u.getid(), _u.gamename()
local natui_url = game:HttpGet("https://raw.githubusercontent.com/Baim9182/BelajarHub/refs/heads/main/ui.lua", true)
local NatUI = loadstring(natui_url)()
if script_id then
    task.spawn(function()loadstring(game:HttpGet("https://raw.githubusercontent.com/dy1zn4t/NatHub/refs/heads/main/src/v", true))()end)
  --[[  if not premium then
        local auth = _u.load("https://raw.githubusercontent.com/ArdyBotzz/NatHub/refs/heads/master/keysystem.lua", true)
    ...
    task.spawn(function()
        NatUI:Notify({
            Title = "Belajar Hub",
            Content = game_name .. " script loaded!",
            Duration = 10,
        })
        task.wait(5)
        NatUI:Notify({
    ...
    _u.load("https://api.luarmor.net/files/v4/loaders/" .. script_id .. ".lua")
end
